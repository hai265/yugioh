...
#                       .encode('utf-8'))
#         game_state = json.loads(sock1.recv(4096))
...
#                       .encode('utf-8'))
#         game_state2 = json.loads(sock1.recv(4096))
...
#         game_state = pickle.loads(sock2.recv(4096))
#         self.assertTrue(game_state.session_id == 1)
#         self.assertTrue(game_state.game_status == GameStatus.ONGOING)

#         sock1.sendall(json.dumps({"operation": "delete", "session_id": session_id, "get_pickle": True}).encode('utf-8'))
#         game1 = pickle.loads(sock1.recv(8192))
#         game2 = pickle.loads(sock2.recv(8192))
